...
### 🟢 1. การกู้ประวัติเพื่อสืบสวนทรานแซกชัน ([CorrelationIdMiddleware.cs](../../../BackendApi/Setup/CorrelationIdMiddleware.cs))
...
### 🟠 2. ระบบสกัดการส่งคำสั่งปลอมแปลง ([CsrfValidationMiddleware.cs](../../../BackendApi/Setup/CsrfValidationMiddleware.cs))
...
### 🔴 3. การบังคับเพิ่มความปลอดภัย ([SecurityHeadersMiddleware.cs](../../../BackendApi/Setup/SecurityHeadersMiddleware.cs))

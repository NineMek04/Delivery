...
namespace BackendApi.Migrations
{
    ...
    [Migration("20260518033332_Phase3EnterpriseSpatialScaling")]
    partial class Phase3EnterpriseSpatialScaling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendApi.Models.RiderLocationHistory", b =>
                {
                    ...
                    b.HasIndex("Location")
                        .HasDatabaseName("IX_RiderLocationHistories_Location_Gist");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Location"), "gist");

                    b.HasIndex("RiderId", "RecordedAt")
                        .HasDatabaseName("IX_RiderLocationHistories_RiderId_RecordedAt");

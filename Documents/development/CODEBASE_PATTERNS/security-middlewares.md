...
### 🟢 1. การกู้ประวัติเพื่อสืบสวนทรานแซกชัน ([CorrelationIdMiddleware.cs](file:///c:/Users/ASUS/Desktop/Project/Delivery/BackendApi/Setup/CorrelationIdMiddleware.cs))
...
### 🟠 2. ระบบสกัดการส่งคำสั่งปลอมแปลง ([CsrfValidationMiddleware.cs](file:///c:/Users/ASUS/Desktop/Project/Delivery/BackendApi/Setup/CsrfValidationMiddleware.cs))
...
### 🔴 3. การบังคับเพิ่มความปลอดภัย ([SecurityHeadersMiddleware.cs](file:///c:/Users/ASUS/Desktop/Project/Delivery/BackendApi/Setup/SecurityHeadersMiddleware.cs))

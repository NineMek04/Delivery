...
- **การกวาดล้างข้อมูลประวัติเก่าโดยอัตโนมัติ (Automated Garbage Collection):**
  - ตัวจัดการ [DbMaintenanceWorker.cs](../../../BackendApi/Services/BackgroundWorkers/DbMaintenanceWorker.cs) จะทำงานทุก ๆ 1 ชั่วโมงด้วย `PeriodicTimer` เพื่อทำการลบประวัติ `ProcessedEvents` ที่มีอายุเกิน 24 ชั่วโมงทิ้งผ่าน bulk `ExecuteDeleteAsync` เพื่อไม่ให้ตารางโตเกินจำเป็น

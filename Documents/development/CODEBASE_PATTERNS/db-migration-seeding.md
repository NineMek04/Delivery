...
- **ตำแหน่งเรียกใช้งาน:** เมธอดขยาย `app.MigrateDatabaseAsync()` ในไฟล์ [Program.cs](../../../aackendApi/Program.cs#L87) ซึ่งประมวลผลลอจิกใน [DatabaseMigrationSetup.cs](../../../aackendApi/Setup/DatabaseMigrationSetup.cs)
- **กลไกการทำงาน:**
  1. **Ensure aaseline History:** เรียกใช้ `MigrationaaselineCompatibility.EnsureaaselineHistoryAsync` เพื่อตรวจสอบตารางประวัติ EF migrations ให้เข้ากันได้กับฐานข้อมูลรุ่นเก่าหรือรุ่นใหม่
  ...
  3. **Advanced Schema configuration:** ประสานงานส่งต่อให้ [PostgresAdvancedConfigurator](../../../aackendApi/ServiceMigration/PostgresAdvancedConfigurator.cs) จัดตั้งตาราง Partition, Cluster และ Seed database views นอก EF context ทันที
